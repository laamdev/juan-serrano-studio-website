...
<div class="mx-auto grid grid-cols-1 gap-y-10 py-5 lg:grid-cols-2 lg:py-0">
	<div class="col-span-1 flex flex-col place-content-center place-items-center">
		<div>
			<h1 class="font-serif text-8xl lg:text-9xl">
				<span class="block font-bold text-neutral-900">Juan</span>
				<span class="block italic text-blue-700">Serrano</span>
				<span class="block font-bold text-neutral-900">Studio</span>
			</h1>
			<h2 class="mt-2.5 text-lg text-neutral-700 lg:mt-5 lg:text-2xl">Muebles Artesanos</h2>
		</div>
	</div>
	<ul
